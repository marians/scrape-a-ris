...
BASE_URL = 'https://sessionnet.krz.de/ulmen/bi/'
...
# Month calender page
CALENDAR_MONTH_URL_PARSE_PATTERN = 'si0040.asp?__cjahr={year:d}&__cmonat={month:d}'
CALENDAR_MONTH_URL_PRINT_PATTERN = BASE_URL + 'si0040.asp?__cjahr=%d&__cmonat=%d'

# Session detail page
SESSION_DETAIL_URL_PARSE_PATTERN = BASE_URL + 'to0040.asp?__ksinr={session_id:d}'
SESSION_DETAIL_URL_PRINT_PATTERN = BASE_URL + 'to0040.asp?__ksinr=%d'

# Committee detail page
COMMITTEE_DETAIL_URL_PARSE_PATTERN = 'kp0040.asp?__kgrnr={committee_id:d}'
COMMITTEE_DETAIL_URL_PRINT_PATTERN = BASE_URL + 'kp0040.asp?__kgrnr=%d'

# Submission detail page
SUBMISSION_DETAIL_URL_PARSE_PATTERN = 'vo0050.asp?__kvonr={submission_id:d}'
SUBMISSION_DETAIL_URL_PRINT_PATTERN = BASE_URL + 'vo0050.asp?__kvonr=%d'
...
SESSION_DETAIL_AGENDA_ROWS_SUBMISSION_LINK_XPATH = 'td/a[@class="smc_doc"]'
...
SUBMISSION_DETAIL_AGENDA_ROWS_XPATH = '//*[@id="smc_page_vo0050_contenttable1"]/tbody/tr'
